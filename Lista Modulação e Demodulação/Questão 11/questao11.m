...
gamma = 0
phi = -pi/6
v = w + A0*cos(2*pi*(f0+gamma)*t+phi)
...
#figure(7)
plot(t,w,'-r',t-0.07,-m/2-1,'-b','linewidth',1)
legend('mensagem','recuperado')
title('modulação Lei-Quadrática para desvio de frequência = 0 Hz e de fase = -pi/6')
xlim([0 0.5])
ylim([-1.75 0.75])
xlabel("segundos")
ylabel("amplitude")
